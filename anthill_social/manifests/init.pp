...
class anthill_social (
  ...
  String $service_name                          = $anthill_social::params::service_name,

  String $repository_remote_url                 = $anthill_social::params::repository_remote_url,
  String $source_directory                      = $anthill_social::params::source_directory,

  String $db_location                           = $anthill_social::params::db_location,
  Boolean $manage_db                            = true,
  String $db_name                               = $anthill_social::params::db_name,

  String $token_cache_location                  = $anthill_social::params::token_cache_location,
  Integer $token_cache_db                       = $anthill_social::params::token_cache_db,
  Integer $token_cache_max_connections          = $anthill_social::params::token_cache_max_connections,
  ...
  String $cache_location                        = $anthill_social::params::cache_location,
